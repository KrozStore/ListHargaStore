  ...
  <body>
    ...
    <script>
      function fetchProducts() {
        ...
        xhr.open(
          "GET",
          "https://openapi.bukaolshop.net/v1/app/produk?token=eyJhcHAiOiIxMjE4MTUiLCJhdXRoIjoiMjAyMjEyMTQiLCJzaWduIjoia1REb3Ztc3RaSktRcFNudk5YXC8zVkE9PSJ9&page=1&total_data=50&id_kategori=379641",
          true
        );
